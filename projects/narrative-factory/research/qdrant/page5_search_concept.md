...
URL Source: https://qdrant.tech/documentation/concepts/search/
...
![Image 1: This is how vector similarity works](https://qdrant.tech/docs/encoders.png)
...
*   Manhattan distance: `Manhattan`*- [https://en.wikipedia.org/wiki/Taxicab_geometry](https://en.wikipedia.org/wiki/Taxicab_geometry)_*Available as of v1.7_

The most typical metric used in similarity learning models is the cosine metric.

![Image 2: Embeddings](https://qdrant.tech/docs/cos.png)
...
![Image 3: Group id matches point id](https://qdrant.tech/docs/lookup_id_linking.png)
