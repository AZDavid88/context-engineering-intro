...
class VolatilityScalingSeed(BaseSeed):
    ...
    def calculate_technical_indicators(self, data: pd.DataFrame) -> Dict[str, pd.Series]:
        ...
        return {
            ...
            'high_vol_regime': safe_fillna_false(high_vol_persistent),
            'low_vol_regime': safe_fillna_false(low_vol_persistent),
            'vol_cluster': safe_fillna_false(vol_cluster),
    ...
    def generate_signals(self, data: pd.DataFrame) -> pd.Series:
        ...
        combined_signals = safe_fillna_zero(combined_signals)
